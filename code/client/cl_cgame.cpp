...
extern menuDef_t *Menus_FindByName(const char *p);
#ifdef EF_MODE
// EF cgame syscall enum values (from codeEF/cgame/cg_public.h)
enum cgameEFImport_t {
	EF_CG_PRINT, EF_CG_ERROR, EF_CG_MILLISECONDS, EF_CG_CVAR_REGISTER,
	EF_CG_CVAR_UPDATE, EF_CG_CVAR_SET, EF_CG_ARGC, EF_CG_ARGV, EF_CG_ARGS,
	EF_CG_FS_FOPENFILE, EF_CG_FS_READ, EF_CG_FS_WRITE, EF_CG_FS_FCLOSEFILE,
	EF_CG_SENDCONSOLECOMMAND, EF_CG_ADDCOMMAND, EF_CG_SENDCLIENTCOMMAND,
	EF_CG_UPDATESCREEN, // 16
	EF_CG_CM_LOADMAP, // 17 (JKA=20)
	EF_CG_CM_NUMINLINEMODELS, EF_CG_CM_INLINEMODEL, EF_CG_CM_TEMPBOXMODEL,
	EF_CG_CM_POINTCONTENTS, EF_CG_CM_TRANSFORMEDPOINTCONTENTS,
	EF_CG_CM_BOXTRACE, EF_CG_CM_TRANSFORMEDBOXTRACE, EF_CG_CM_MARKFRAGMENTS,
	EF_CG_S_STARTSOUND, EF_CG_S_STARTLOCALSOUND, // 27
	EF_CG_S_CLEARLOOPINGSOUNDS, EF_CG_S_ADDLOOPINGSOUND,
	EF_CG_S_UPDATEENTITYPOSITION, EF_CG_S_RESPATIALIZE,
	EF_CG_S_REGISTERSOUND, EF_CG_S_STARTBACKGROUNDTRACK,
	EF_CG_FF_STARTFX, EF_CG_FF_ENSUREFX, EF_CG_FF_STOPFX, EF_CG_FF_STOPALLFX, // 34-37
	EF_CG_R_LOADWORLDMAP, // 38 (JKA=CG_R_LOADWORLDMAP=122)
	EF_CG_R_REGISTERMODEL, EF_CG_R_REGISTERSKIN,
	EF_CG_R_REGISTERSHADER, EF_CG_R_REGISTERSHADERNOMIP,
	EF_CG_R_CLEARSCENE, EF_CG_R_ADDREFENTITYTOSCENE,
	EF_CG_R_GETLIGHTING, EF_CG_R_ADDPOLYTOSCENE, EF_CG_R_ADDLIGHTTOSCENE,
	EF_CG_R_RENDERSCENE, EF_CG_R_SETCOLOR, EF_CG_R_DRAWSTRETCHPIC,
	EF_CG_R_DRAWSCREENSHOT, EF_CG_R_MODELBOUNDS, EF_CG_R_LERPTAG,
	EF_CG_R_DRAWROTATEPIC, EF_CG_R_SCISSOR, // 54, 55
	EF_CG_GETGLCONFIG, // 56
	EF_CG_GETGAMESTATE, EF_CG_GETCURRENTSNAPSHOTNUMBER,
	EF_CG_GETSNAPSHOT, EF_CG_GETSERVERCOMMAND,
	EF_CG_GETCURRENTCMDNUMBER, EF_CG_GETUSERCMD, EF_CG_SETUSERCMDVALUE,
	EF_CG_MEMORY_REMAINING, // 64
	EF_CG_S_UPDATEAMBIENTSET, EF_CG_S_ADDLOCALSET,
	EF_CG_AS_PARSESETS, EF_CG_AS_ADDENTRY, EF_CG_AS_GETBMODELSOUND,
	EF_CG_S_GETSAMPLELENGTH // 70
};

static cgameImport_t CL_ConvertEFSysCall( int efSyscall ) {
	switch ( efSyscall ) {
	// 0-16: identical
	case EF_CG_PRINT: return CG_PRINT;
	case EF_CG_ERROR: return CG_ERROR;
	case EF_CG_MILLISECONDS: return CG_MILLISECONDS;
	case EF_CG_CVAR_REGISTER: return CG_CVAR_REGISTER;
	case EF_CG_CVAR_UPDATE: return CG_CVAR_UPDATE;
	case EF_CG_CVAR_SET: return CG_CVAR_SET;
	case EF_CG_ARGC: return CG_ARGC;
	case EF_CG_ARGV: return CG_ARGV;
	case EF_CG_ARGS: return CG_ARGS;
	case EF_CG_FS_FOPENFILE: return CG_FS_FOPENFILE;
	case EF_CG_FS_READ: return CG_FS_READ;
	case EF_CG_FS_WRITE: return CG_FS_WRITE;
	case EF_CG_FS_FCLOSEFILE: return CG_FS_FCLOSEFILE;
	case EF_CG_SENDCONSOLECOMMAND: return CG_SENDCONSOLECOMMAND;
	case EF_CG_ADDCOMMAND: return CG_ADDCOMMAND;
	case EF_CG_SENDCLIENTCOMMAND: return CG_SENDCLIENTCOMMAND;
	case EF_CG_UPDATESCREEN: return CG_UPDATESCREEN;
	// 17+: diverge (JKA has terrain syscalls 17-19 that EF doesn't)
	case EF_CG_CM_LOADMAP: return CG_CM_LOADMAP;
	case EF_CG_CM_NUMINLINEMODELS: return CG_CM_NUMINLINEMODELS;
	case EF_CG_CM_INLINEMODEL: return CG_CM_INLINEMODEL;
	case EF_CG_CM_TEMPBOXMODEL: return CG_CM_TEMPBOXMODEL;
	case EF_CG_CM_POINTCONTENTS: return CG_CM_POINTCONTENTS;
	case EF_CG_CM_TRANSFORMEDPOINTCONTENTS: return CG_CM_TRANSFORMEDPOINTCONTENTS;
	case EF_CG_CM_BOXTRACE: return CG_CM_BOXTRACE;
	case EF_CG_CM_TRANSFORMEDBOXTRACE: return CG_CM_TRANSFORMEDBOXTRACE;
	case EF_CG_CM_MARKFRAGMENTS: return CG_CM_MARKFRAGMENTS;
	case EF_CG_S_STARTSOUND: return CG_S_STARTSOUND;
	case EF_CG_S_STARTLOCALSOUND: return CG_S_STARTLOCALSOUND;
	case EF_CG_S_CLEARLOOPINGSOUNDS: return CG_S_CLEARLOOPINGSOUNDS;
	case EF_CG_S_ADDLOOPINGSOUND: return CG_S_ADDLOOPINGSOUND;
	case EF_CG_S_UPDATEENTITYPOSITION: return CG_S_UPDATEENTITYPOSITION;
	case EF_CG_S_RESPATIALIZE: return CG_S_RESPATIALIZE;
	case EF_CG_S_REGISTERSOUND: return CG_S_REGISTERSOUND;
	case EF_CG_S_STARTBACKGROUNDTRACK: return CG_S_STARTBACKGROUNDTRACK;
	// Force feedback: stub these (EF-specific, not in JKA)
	case EF_CG_FF_STARTFX: return (cgameImport_t)-1;
	case EF_CG_FF_ENSUREFX: return (cgameImport_t)-1;
	case EF_CG_FF_STOPFX: return (cgameImport_t)-1;
	case EF_CG_FF_STOPALLFX: return (cgameImport_t)-1;
	// Renderer
	case EF_CG_R_LOADWORLDMAP: return CG_R_LOADWORLDMAP;
	case EF_CG_R_REGISTERMODEL: return CG_R_REGISTERMODEL;
	case EF_CG_R_REGISTERSKIN: return CG_R_REGISTERSKIN;
	case EF_CG_R_REGISTERSHADER: return CG_R_REGISTERSHADER;
	case EF_CG_R_REGISTERSHADERNOMIP: return CG_R_REGISTERSHADERNOMIP;
	case EF_CG_R_CLEARSCENE: return CG_R_CLEARSCENE;
	case EF_CG_R_ADDREFENTITYTOSCENE: return CG_R_ADDREFENTITYTOSCENE;
	case EF_CG_R_GETLIGHTING: return CG_R_GETLIGHTING;
	case EF_CG_R_ADDPOLYTOSCENE: return CG_R_ADDPOLYTOSCENE;
	case EF_CG_R_ADDLIGHTTOSCENE: return CG_R_ADDLIGHTTOSCENE;
	case EF_CG_R_RENDERSCENE: return CG_R_RENDERSCENE;
	case EF_CG_R_SETCOLOR: return CG_R_SETCOLOR;
	case EF_CG_R_DRAWSTRETCHPIC: return CG_R_DRAWSTRETCHPIC;
	case EF_CG_R_DRAWSCREENSHOT: return (cgameImport_t)-1; // EF-specific screenshot drawing
	case EF_CG_R_MODELBOUNDS: return CG_R_MODELBOUNDS;
	case EF_CG_R_LERPTAG: return CG_R_LERPTAG;
	case EF_CG_R_DRAWROTATEPIC: return CG_R_DRAWROTATEPIC;
	case EF_CG_R_SCISSOR: return CG_R_SCISSOR;
	// Game state / snapshots
	case EF_CG_GETGLCONFIG: return CG_GETGLCONFIG;
	case EF_CG_GETGAMESTATE: return CG_GETGAMESTATE;
	case EF_CG_GETCURRENTSNAPSHOTNUMBER: return CG_GETCURRENTSNAPSHOTNUMBER;
	case EF_CG_GETSNAPSHOT: return CG_GETSNAPSHOT;
	case EF_CG_GETSERVERCOMMAND: return CG_GETSERVERCOMMAND;
	case EF_CG_GETCURRENTCMDNUMBER: return CG_GETCURRENTCMDNUMBER;
	case EF_CG_GETUSERCMD: return CG_GETUSERCMD;
	case EF_CG_SETUSERCMDVALUE: return CG_SETUSERCMDVALUE;
	case EF_CG_MEMORY_REMAINING: return (cgameImport_t)-2; // handled specially
	// Ambient sound
	case EF_CG_S_UPDATEAMBIENTSET: return CG_S_UPDATEAMBIENTSET;
	case EF_CG_S_ADDLOCALSET: return CG_S_ADDLOCALSET;
	case EF_CG_AS_PARSESETS: return CG_AS_PARSESETS;
	case EF_CG_AS_ADDENTRY: return CG_AS_ADDENTRY;
	case EF_CG_AS_GETBMODELSOUND: return CG_AS_GETBMODELSOUND;
	case EF_CG_S_GETSAMPLELENGTH: return CG_S_GETSAMPLELENGTH;
	default:
		Com_Printf(S_COLOR_YELLOW "CL_ConvertEFSysCall: unknown EF syscall %d\n", efSyscall);
		return (cgameImport_t)-1;
	}
}
#endif // EF_MODE
...
#elif defined(EF_MODE)
	cgameImport_t converted = CL_ConvertEFSysCall( (int)args[0] );
	if ( (int)converted == -1 ) {
		// Stubbed syscall (force feedback, screenshot, etc.)
		return 0;
	}
	if ( (int)converted == -2 ) {
		// CG_MEMORY_REMAINING: return large value (plenty of memory)
		return 256 * 1024 * 1024;
	}
	args[0] = (intptr_t)converted;
#endif
#ifdef EF_MODE
