// ui_player.c
// CG_PLAYERS_CPP removed -- animTable is defined in cg_players.cpp
// when building as combined DLL (SP_GAME mode)
...
// In combined DLL mode, these are already defined in NPC_stats.cpp
#ifndef SP_GAME
