...
// When building as combined DLL (OpenJK SP pattern), Com_Printf/Com_Error
// are already provided by the game module. Only define UI versions for
// standalone UI DLL builds.
#if !defined(UI_HARD_LINKED) && !defined(SP_GAME)
